...
export default function Navbar() {
  return (
    <div className="w-screen h-16 mt-[35px] flex justify-between px-20 items-center ">
        <div className="logo">
                <img src="image 5.svg" alt="logo" />
        </div>
        <div className="Navigation flex justify-evenly items-end h-full w-[70%] text-2xl  font-Pop">
